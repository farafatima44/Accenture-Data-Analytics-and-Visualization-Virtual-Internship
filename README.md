...
## Preview Image:
![Dashboard Preview(https://github.com/farafatima44/Accenture-Data-Analytics-and-Visualization-Virtual-Internship/blob/main/Dashboard%20-%20Social%20Buzz.png)]
...
**A data analyst sits between the business and the data.**
 ...
 - About Client : [Social Buzz](https://github.com/farafatima44/Accenture-Data-Analytics-and-Visualization-Virtual-Internship/blob/main/Data_Analytics%20Client%20Brief.pdf)
...
**End result will be one spreadsheet**
 ...
 ### Cleaned Data set:
 So, the cleaned data set after data modelling & data cleaning : [Cleaned Dataset](https://github.com/farafatima44/Accenture-Data-Analytics-and-Visualization-Virtual-Internship/blob/main/Cleaned%20Data.xlsx)
 
 ## Task - 3
 ### Data Visualization and Storytelling:
 **Make the PowerPoint presentation as per the given template**
 
 - Powerpoint Presentation : [PPT](https://github.com/farafatima44/Accenture-Data-Analytics-and-Visualization-Virtual-Internship/blob/main/Presentation.pptx) 
 ## Task - 4
 ### Present to the Client:
 **Present your PowerPoint presentation to the client and deliver the insights of your analysis** 

 ## Certificate:
[Certificate of Completion](https://github.com/farafatima44/Accenture-Data-Analytics-and-Visualization-Virtual-Internship/blob/main/Accenture%20Virtual%20Internship%20Certificate.pdf)

 ## Connect with Me:
Follow me on LinkedIn for more data analysis projects and insights: [LinkedIn Profile](https://www.linkedin.com/in/farafatima)
